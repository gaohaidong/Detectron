...
if __name__ == '__main__':
    # read_pkl('trained_models/retinanet_X-101-64x4d-FPN_2x/train/cloth_train/retinanet/model_iter149999.pkl', 'ret-x-101-new.pkl')
    ...
    # read_pkl_blobs('imagenet_models/X-101-64x4d.pkl')
